...
export default function PrivacyPolicy() {
  return (
    <div className="px-8 md:px-32 sm:px-24 pt-12 pb-32 privacy-policy__container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Soccer For Change.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Soccer For Change, accessible
            from{" "}
            <a
              href="https://soccerforchange.org"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://soccerforchange.org
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: contactsoccerforchange@gmail.com</li>
      </ul>
    </div>
  );
}
